      ...
      <div className="login-bottom">
        ...
        {phase.kind === "waiting" ? (
          ...
          <div className="login-action">
            ...
            {phase.kind === "starting" ? (
              <LoginButton variant="google" disabled busy>
                Signing in…
              </LoginButton>
            ) : (
              <LoginButton variant="google" onClick={onSignIn}>
                Sign in with Google
              </LoginButton>
            )}
            <sp-help-text size="s" className="login-help-center">
...
function LoginButton({
  ...
  return (
    ...
    >
      {variant === "google" && (
        <span className="login-btn-gicon" aria-hidden>
          <GoogleG />
        </span>
      )}
      {children}
...
// Official multicolour Google "G" (per Google's Sign-In branding guidelines — do not recolour or
// restyle the mark). Inline SVG renders in UXP (sp-icon web components do not).
function GoogleG() {
  return (
